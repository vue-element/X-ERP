    ...
    <div class="form-head-attached">
      <div class="form-inner">
        <div class="crud-btn fl">
          <button @click="toggleTab('searchTab')" :class="tab === 'searchTab' ? 'is-active' : ''" v-if="hasPerm('contractPayment:search')">
            <i class="iconfont icon-search"></i>
            <span>查询</span>
          </button>
          <button :class="tab === 'listTab' ? 'is-active' : ''" @click="listBtn" v-if="hasPerm('contractPayment:findAllByPage')">
            <i class="iconfont icon-seeAll"></i>
            <span>查看</span>
          </button>
          <button :class="(tab === 'addTab' && editData.tabState === 'addTab') ? 'is-active' : ''" @click="addBtn" v-if="hasPerm('contractPayment:save')">
        ...
        <div class="export-btn fr">
          <button @click="dataImpore" :class="tab === 'importTab' ? 'is-active' : ''" v-if="hasPerm('contractPayment:importData')">
...
export default {
  ...
  methods: {
    ...
    handleDownload(Arr) {
      this.$post('/contractPayment/export').then(res => {
