    ...
    <div class="form-head-attached">
      <div class="form-inner">
        <div class="crud-btn fl">
          <button v-if="hasPerm('price:search')" @click="toggleTab('searchTab')" :class="tab === 'searchTab' ? 'is-active' : ''">
            <i class="iconfont icon-search"></i>
            <span>查询</span>
          </button>
          <button v-if="hasPerm('price:findAllByPage')" @click="toggleTab('listTab')" :class="tab === 'listTab' ? 'is-active' : ''">
            <i class="iconfont icon-seeAll"></i>
            <span>查看</span>
          </button>
          <button v-if="hasPerm('price:save')" @click="addBtn" :class="(tab === 'addTab' && editData.tabState ==='addTab') ? 'is-active' : ''">
        ...
        <div class="export-btn fr">
          ...
          <button v-if="hasPerm('price:export')" @click="handleDownload('Arr')" :loading="downloadLoading">
