  ...
  <div class="contract-list">
    <div class="table">
      <el-table class="basic-form" style="width: 100%" :data="tableData" :height="height" v-loading.body="listLoading" border>
        ...
        <el-table-column prop="contractInfo.name" label="合同名称／所属项目" fixed width="300"></el-table-column>
        ...
        <el-table-column prop="code" label="付款合同编号" fixed width="260"></el-table-column>
        ...
        <el-table-column prop="acAmount" label="实际采购金额" width="140"></el-table-column>
        <el-table-column prop="adAmount" label="计划采购金额" width="140"></el-table-column>
