...
export const asyncRouterMap = [
  ...
  { path: '/basic', component: Layout, redirect: 'noredirect', name: 'basic', meta: { title: '基础管理', icon: 'pCenter' },
    children: [
      ...
      { path: 'permission', component: _import('basic/permission/index'), name: 'permission', meta: { title: '权限管理' }, menu: 'org' },
      { path: 'role', component: _import('basic/role/index'), name: 'role', meta: { title: '角色管理' }, menu: 'org' }
    ]
  },
  // 市场管理
  ...
  { path: '/financial', component: Layout, redirect: 'noredirect', name: 'financial', meta: { title: '财务管理', icon: 'money', role: ['cw'] },
    children: [
      ...
      { path: 'payment', component: _import('financial/payment/index'), name: 'payment', meta: { title: '合同成本管理' }, menu: 'contractPayment' },
